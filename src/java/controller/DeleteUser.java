...
public class DeleteUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String name = db.getUserById(Integer.parseInt(request.getParameter("id"))).getUsername();
        String output="Delete "+name+" Successfully";  
        int result = db.deleteUser(Integer.parseInt(request.getParameter("id")));
